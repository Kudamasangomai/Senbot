...
?>
                                        <tr id="<?php echo $rowrepairs->jobcardno; ?>" >
...

{
 ...
 echo "</li>";
  echo "<li>";
 echo anchor("create_con/edit_job/$rowrepairs->jobcardno",'Edit');
  echo "</li>";
   echo "<li>";
 echo anchor("main/closemyjob/$rowrepairs->jobcardno",'Close');
  echo "</li>";
...
}else if($rowrepairs->status = 'Pending')
{
  ...
  // echo anchor("main/assign/$rowrepairs->jobcardno",'Assign');
   ...
   echo "<li>";
   ?>
  <!--echo anchor("main/delete/$rowrepairs->jobcardno",'delete'); -->
